...
public class TestCase_04 {
    ...
    public void TestCase04() {
        ...
        try {
            ...
            String firstName = getRandomString(8); // Generate a random first name
            String lastName = getRandomString(8); // Generate a random last name
            String email = getRandomEmail(); // Generate a random email
            ...
            input1.clear();
            input1.sendKeys("linhpnse173687@fpt.edu.vn");
