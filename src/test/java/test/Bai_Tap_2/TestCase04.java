...
public class TestCase04 {
    ...
    public void TestCase04() {
        ...
        try {
            ...
            WebElement compareProductsButton = driver.findElement(By.cssSelector(".block-compare .block-title span"));
            ...
            WebElement sonyXperiaInCompareProducts = driver
                    .findElement(By.cssSelector(".block-compare .block-content #compare-items .odd .product-name a"));
            WebElement iphoneInCompareProducts = driver
                    .findElement(By.cssSelector(".block-compare .block-content #compare-items .last .product-name a"));
