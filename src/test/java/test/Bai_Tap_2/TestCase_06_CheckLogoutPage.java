...
public class TestCase_06_CheckLogoutPage {
    WebElement Elem = null;
    Select Dropdown = null;
    private WebDriver driver;

    public TestCase_06_CheckLogoutPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    // public void enterShippingInformation(String newAddress, String fisrtName,
    // String middleName, String lastName,
    // String company, String address, String streetAddress2, String city,
    // String state, String zip, String country, String telephone, String fax) {
    // WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    // Elem =
    // wait.until(ExpectedConditions.presenceOfElementLocated(newShippingAddressBox));
