...
public class TestCase_08_CheckOutPage {
    WebElement Elem = null;
    Select Dropdown = null;
    private WebDriver driver;

    public TestCase_08_CheckOutPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    private final By ContinueShippingMethodSelector = By
            .cssSelector("button[onclick='shippingMethod.save()'] span span");
